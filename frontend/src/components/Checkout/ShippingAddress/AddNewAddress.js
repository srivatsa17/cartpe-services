...
function AddNewAddress({ showNewAddressModal, setShowNewAddressModal, handleAddNewShippingAddress }) {
    ...
    const schema = yup.object().shape({
        ...
        type:   yup.string().default("Home").required().oneOf(addressTypeOptions, "Address type is required."),
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        </Modal.Header>
                        {
                            ...
                            <Modal.Body>
                                ...
                                <Form.Group className="mb-3">
                                    {
                                        addressTypeOptions.map((addressType, index) => {
                                            return (
                                                <Field
                                                    as={Form.Check}
                                                    name="type"
                        ...
                        <Modal.Footer>
                            <Button variant="dark" onClick={handleCloseNewAddressModal} disabled={isSubmitting}>
                                Close
                            </Button>
                            {
                                ( !isLoading && !error ) &&
