...
class Order(models.Model):
    ...
    user_address = models.ForeignKey(to = UserAddress, on_delete = models.PROTECT, null = False, blank = False, related_name = 'order')
    ...
    refund_status = models.CharField(max_length = 255, choices = OrderRefundStatus.ORDER_REFUND_STATUS_CHOICES, default = OrderRefundStatus.NA, null = False, blank = False)
...
class OrderItem(models.Model):
    ...
    product_variant = models.ForeignKey(to = ProductVariant, on_delete = models.PROTECT, null = False, blank = False, related_name = 'order_item')
