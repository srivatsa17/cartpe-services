...
class Order(models.Model):
    ...
    status = models.CharField(choices = ORDER_STATUS_CHOICES, default = PENDING, null = False, blank = False)
    razorpay_order_id = models.CharField(default = "", null = False, blank = False)
