...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    total_discount_price = serializers.DecimalField(max_digits = 7, decimal_places = 2, coerce_to_string = False)
    total_selling_price = serializers.DecimalField(max_digits = 7, decimal_places = 2, coerce_to_string = False)
    ...
    class Meta:
        model = Payment
        fields = [
            'id', 'order', 'total_mrp', 'total_discount_price', 'total_selling_price', 'convenience_fee', 
            'shipping_fee', 'total_amount', 'round_off_price', 'savings_amount', 'savings_percent', 
